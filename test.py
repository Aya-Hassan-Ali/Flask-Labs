...
def create_student():
	with app.app_context():
		student = Student(name='aya hassan',age='11',username='ayahassan33', email='ayahassan33@gmail.com', password='123')
...
def update_student():
	with app.app_context():
		student = Student.query.filter_by(username="ayahassan33").first()
		student.username = 'ayahassan33'
		db.session.commit()
  		# print(student)
